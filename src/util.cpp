...
const char * const BITCOIN_CONF_FILENAME = "mazacoin.conf";
const char * const BITCOIN_PID_FILENAME = "mazacoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mazacoin";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strCopyrightHolders.find("Mazacoin Core developers") == strCopyrightHolders.npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Mazacoin Core developers";
    }
